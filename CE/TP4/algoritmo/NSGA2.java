...
import individuo.IndividuoFactoryDTLZ1;
import individuo.IndividuoFactoryDTLZ2;
...
public class NSGA2 {
    ...
    public void execute(IndividuoFactory individuoFactory, int nPop, int qtdEpocas) {
        ...
        while (e <= qtdEpocas) {
            ...
            if (e == 1 || e == 20 || e == 40|| e == 60 || e == 80|| e == 100 || e == 1000) {
    ...
    public static void main(String[] args) {
        ...
        IndividuoFactoryDTLZ1 indDTLZ1 = new IndividuoFactoryDTLZ1(7, 3);
        IndividuoFactoryDTLZ2 indDTLZ2 = new IndividuoFactoryDTLZ2(7, 3);

        NSGA2 nsga2 = new NSGA2();
        //nsga2.execute(factory, 21, 1000);
        //nsga2.execute(indDTLZ1, 21, 1000);
        nsga2.execute(indDTLZ2, 21, 1000);
    }
