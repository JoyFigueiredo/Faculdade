...
public class Individuo {
    ...
    */
    ...
    public List<Individuo> recombinar(Individuo p2) {
        ...
        double[][] filhosMat = crossOver.getOffSpring(this.genes, p2.genes, this.problema.getLowerBounds(),
				this.problema.getUpperBounds());
    ...
    public void mutar() {
        this.genes = mutation.getMutation(this.genes, new double[] {-50,-50}, new double[] {50,50});
    }
